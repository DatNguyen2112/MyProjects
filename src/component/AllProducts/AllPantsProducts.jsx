...
function AllPantsProducts({user}) {
    ...
    const filterFunction = (text) => {
        if (fetchShirt.length > 1) {
            const filter = fetchShirt.filter((shirt) => shirt.categorysItem === text);
    ...
    return (
        <div>
            ...
            <div className='SignIn__title'>
                <h3 className='SignIn__text'>Quần</h3>
            </div>
...
export default AllPantsProducts
