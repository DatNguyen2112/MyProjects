...
function AllPriceLowThan500({ user }) {
  ...
  const filterFunction = (text) => {
    if (fetchPriceLow500.length > 1) {
      const filter = fetchPriceLow500.filter((product) => product.categorys === text);
  ...
  return (
    <div>
      ...
      <div className="SignIn__title">
        <h3 className="SignIn__text">Sản phẩm dưới 500 nghìn</h3>
      </div>
...
export default AllPriceLowThan500;
