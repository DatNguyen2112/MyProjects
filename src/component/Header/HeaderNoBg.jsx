...
function HeaderNoBg({ user }) {
  ...
  return (
    <div>
      <div className="Header__bg noPosition">
        {showSearch ? (
          <>
        ...
        {!user && (
          <div className="Header__navbar">
            <ul>
              ...
              <li className="Header__navbar-item">Lăng kính SOFY</li>
            </ul>
          </div>
        )}
